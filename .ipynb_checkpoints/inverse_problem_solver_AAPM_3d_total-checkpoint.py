...
# Configurations
###############################################
problem = 'sparseview_CT_add_fusion_total'
...
# for i in range(256):
#     for j in range(256):
#        data2[i,j] = img[0, 0,i,j]
sinogram= radon.A(img)


# data3=np.zeros((363,3))
# for i in range(363):
#     for j in range(3):
#         data3[i,j]=sinogram[0,0,i,j]



# #有用的
# # data2=np.zeros((256,256))
# # all_img2= np.array(all_img)
# # for i in range(256):
# #     for j in range(256):
# #         if i<50 or j<50 or i>206 or j>206:
# #             all_img2[0,0,i,j]=0
# # for i in range(256):
# #     for j in range(256):
# #        data2[i,j] = all_img2[0, 0,i,j]
#
# #无用的
# # k2=0
# # for i in range(256):
...
#
# #有用的
# reco = np.zeros((1, 1,363, 2))
#
# # 0
# for i in range(256):
#     for j in range(256):
#         reco[0, 0, i + 53, 0] = reco[0, 0, i + 53, 0] + data2[j, i]
#
# # 45
# for i in range(181):
#         for k in range(256-i):
#            reco[0, 0,i+181,1] = reco[0, 0,i+181,1]+data2[k+i,k]*(2**0.5)
# for i in range(181):
#         for k in range(256-i):
#             if i ==0 and k ==0:
#                 reco[0, 0, i + 181, 1]=0
#             reco[0, 0,-i+181,1] = reco[0, 0,-i+181,1]+data2[k,k+i]*(2**0.5)
# reco2= np.zeros((1,1,363,2))
# for i in range(363):
#     reco2[0, 0, 362-i, 1]=reco[0, 0, i, 1]
# for i in range(363):
#     reco[0, 0, i, 1] = reco2[0, 0, i, 1]
#
# #备份45
# # for i in range(181):
# #         for k in range(256-i):
...
# # for i in range(256):
# #     for j in range(256):
# #        reco[0, 0,i+53,1] = reco[0, 0,i+53,1]+data2[i,j]
#
# #135
# # data3= np.zeros((256,256))
# # for i in range(256):
# #     for j in range(256):
# #        data3[255-i,j] = data2[i,j]
# # for i in range(256):
# #     for j in range(256):
# #        data2[i,j] = data3[i,j]
# #
# # for i in range(181):
# #         for k in range(256-i):
# #            reco[0, 0,i+181,2] = reco[0, 0,i+181,2]+data3[k+i,k]*(2**0.5)
# # for i in range(181):
# #         for k in range(256-i):
# #             if i ==0 and k ==0:
# #                 reco[0, 0, i + 181, 2]=0
# #             reco[0, 0,-i+181,2] = reco[0, 0,-i+181,2]+data3[k,k+i]*(2**0.5)
#
#
...
# for i in range(222):
#     for j in range(2):
#         sinogram[0,0,i+70,j] = reco[0,0,i+70,j]
...
# Recon Image
x = pc_radon(score_model, scaler(img), measurement=sinogram, fbp=bp)
